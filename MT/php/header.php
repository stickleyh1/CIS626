<?php
echo '<head>';
echo '<title>Local Library</title>';
echo '<link href="../css/style.css" rel="stylesheet" />';
echo '<link href="../css/jquery.dataTables.min.css" rel="stylesheet"/>';
echo '<link href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta.2/css/bootstrap.min.css" integrity="sha384-PsH8R72JQ3SOdhVi3uxftmaW6Vc51MKb0q5P2rRUpPvrszuE4W1povHYgTpBfshb" crossorigin="anonymous" rel="stylesheet" >';
...
echo '<script src="../js/dataTables/jquery.dataTables.min.js"></script>';
echo '<script src="../js/dataTables/dataTables.bootstrap4.min.js"></script>';